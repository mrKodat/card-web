...
<body>
    <style>
        :root {
            --theme-five: {{ $basicinfo->primary_color }};
        }
        .bg-primary {
            background-color: var(--theme-five) !important;
        }
    </style>
    <div id="preloader">
        <div id="status">
                    ...
                    <div class="card bg-light border-0 mb-5">
                        ...
                        <div class="card-body main-sec">
                            <div class="about-sec py-4">
                                <h2 class="about-text2">{{ trans('labels.about_us') }}</h2>
                                <p class="px-2 about-content">{!! clean(nl2br(e($basicinfo->description)) ) !!}</p>
                            </div>
                            @if (helper::section_aviable('contact_info', $basicinfo->id, $basicinfo->vendor_id) == 1 && count($contactinfo) > 0)
                            <div class="pb-4">
                                <div class="row justify-content-center contact2-sec ">
                                    ...
                                    @else
                                    <a href="{{ $contact->contact_info }}" class="{{ helper::get_icon_color($contact->title) }}  col-md-3 co
                                            l-sm-4 text-center contect-box" target="_blank">
                                        {!! ($contact->icon ) !!}
                                        <div class="contact2-text">
                                            <p class="text-muted mb-1">{{ $contact->title }}</p>
                                            <p class="content-inner-text text-dark">{{ $contact->contact_info }}</p>
                            ...
                            <div class="service4-sec pb-4">
                                <h2 class="service-text2">{{ trans('labels.services') }}</h2>
                                <div class="owl-carousel carousel_se_01 owl-theme mt-5">
                                    ...
                                    <div class="carousel-item-icon text-center h-100">
                                        ...
                                        <div class="item-cotent">
                                            ...
                                            <a href="{{ $service->purchase_link }}" class="btn btn-primary d-block  mx-auto col-md-6 col-sm-4 my-4 text-white theme-5-btn">
                                                {{ $service->link_title }}
                            ...
                            <div class="more-sec pb-4">
                                ...
                                <a class="btn btn-primary mx-auto d-block col-lg-6 col-sm-6 mb-4 text-white theme-5-btn" href="{{ URL::to($basicinfo->slug . '/savecard') }}">
                                    <i class="fa-light fa-arrow-down-to-bracket"></i>
                                    {{ trans('labels.save_card') }}
                                </a>
                                <a type="button" class="btn mx-auto d-block col-lg-6 col-sm-6 mb-4 text-white theme-5-btn" data-bs-toggle="modal" data-bs-target="#share_card_modal">
                            ...
                            <div class="testimonials-sec pb-4">
                                <h2 class="testimonials-text2 mb-3">{{ trans('labels.testimonials') }}</h2>
                                <div class="row">
                                    <div id="carousel" class="carousel-fade" data-bs-ride="carousel" data-bs-intervel="500">
                            ...
                            <div class="appointment-sec pb-4" id="appointment_section">
                                <h2 class="appointment-text2">{{ trans('labels.appointments') }}</h2>
                                <form method="POST" action="{{ URL::to($basicinfo->slug . '/store_appointments-'.$basicinfo->vendor_id) }}" class="pt-4">
                                    ...
                                    <div class="pt-3">
                                        <button type="submit" class="btn btn-primary mx-auto d-block col-md-6 text-white theme-5-btn">
                            ...
                            <div class="Social-sec pb-4">
                                <h2 class="Social-text2 mb-3">{{ trans('labels.social') }}</h2>
                                <div class="row">
