...
<html>
<head>
    <title>{{ trans('labels.appointment') }}</title>
</head>
<body>
    <div>
        <div style="background:#ffffff;padding:15px">
            <center>
                <div style="width:100%;max-width:500px;background:#ffffff;height:180px">
                    ...
                    <center>
                        <a href="#">
                            <img alt="" src="{{ helper::image_path($logo) }}" width="170" height="170"
                            ...
                            <div style="width:100%;max-width:580px;background:#ffffff;height:auto;padding:20px 0 0px 0">
                                <div
                                    ...
                                    <div bgcolor="#f8f4e8" align="left"
                                        ...
                                        Dear {{ $vendorname }}, {{ $msg }}
                                        <ul>
                                            <li>{{ trans('labels.name') }} : {{ $fullname }}</li>
                                            <li>{{ trans('labels.email') }} : {{ $email }}</li>
                                            <li>{{ trans('labels.mobile') }} : {{ $mobile }}</li>
                                            <li>{{ trans('labels.date') }} : {{ $date }}</li>
                                            <li>{{ trans('labels.time') }} : {{ $time }}</li>
                                        </ul>
                                    </div>
                                    <div
