    ...
    <div class="page-content">
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-3">
                <h5 class="text-uppercase">{{ trans('labels.add_plan') }}</h5>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card border-0 box-shadow">
                        <div class="card-body">
                            <form action="{{ URL::to('admin/plans/store') }}" method="POST">
                                @csrf
                                <div class="row">
                                    <div class="col-sm-6 form-group">
                                        <label class="form-label">{{ trans('labels.name') }}</label>
                                        <input type="text" class="form-control" name="plan_name"
                                            value="{{ old('plan_name') }}" placeholder="{{ trans('labels.name') }}">
                                        @error('plan_name')
                                    ...
                                    <div class="col-sm-6 form-group">
                                        ...
                                        <input type="number" class="form-control" name="plan_price"
                                            value="{{ old('plan_price') }}" placeholder="{{ trans('labels.price') }}">
                                        @error('plan_price')
                                            <small class="text-danger">{{ $message }}</small>
                                        @enderror
                                    </div>
                                    <div class="col-sm-6 form-group">
                                        ...
                                        <select class="form-select" name="plan_duration">
                                            <option value="1" {{ old('plan_duration') == '1' ? 'selected' : '' }}>
                                                {{ trans('labels.one_month') }}</option>
                                            <option value="2" {{ old('plan_duration') == '2' ? 'selected' : '' }}>
                                                {{ trans('labels.three_months') }}</option>
                                            <option value="3" {{ old('plan_duration') == '3' ? 'selected' : '' }}>
                                                {{ trans('labels.six_months') }}</option>
                                            <option value="4" {{ old('plan_duration') == '4' ? 'selected' : '' }}>
                                    ...
                                    <div class="col-sm-6 form-group">
                                        ...
                                        <input type="number" class="form-control" name="plan_appointment_limit"
                                            value="{{ old('plan_appointment_limit') }}"
                                    ...
                                    <div class="col-sm-6 form-group">
                                        ...
                                        <textarea class="form-control" rows="3" name="plan_description" placeholder="{{ trans('labels.description') }}">{{ old('plan_description') }}</textarea>
                                        ...
                                        <ul class="theme-selection">
                                            <li>
                                                <input type="checkbox" name="themecheckbox[]" id="theme1" value="1"
                                                    {{ is_array(old('themecheckbox')) && in_array(1, old('themecheckbox')) ? 'checked' : '' }}>
                                                <label for="theme1">
                                                    <img
                                            ...
                                            <li>
                                                <input type="checkbox" name="themecheckbox[]" id="theme2" value="2"
                                                    {{ is_array(old('themecheckbox')) && in_array(2, old('themecheckbox')) ? 'checked' : '' }}>
                                                <label for="theme2">
                                                    <img
