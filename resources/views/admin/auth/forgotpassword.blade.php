                    ...
                    <div class="col-xl-4 col-lg-6 col-sm-8 col-auto px-5">
                        <div class="card box-shadow overflow-hidden border-0">
                            ...
                            <div class="card-body pt-0">
                                <form class="my-3" method="POST" action="{{ URL::to('admin/sendpassword') }}">
                                    @csrf
                                    ...
                                    <button class="btn btn-primary w-100 my-3" type="submit">{{ trans('labels.send_otp') }}</button>
                                    <p class="fs-7 text-center">{{ trans('labels.dont_have_account') }}
